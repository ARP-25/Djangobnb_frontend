...
const SearchModal = () => {
    ...
    const contentCheckin = (
        <>
            ...
            <div className="mt-6 flex flex-row gap-4">
                ...
                <CustomButton label="Check out date ->" onClick={() => searchModal.open("checkout")} />
            </div>
        </>
    );
    ...
    return <Modal label="Search" content={content} close={searchModal.close} isOpen={searchModal.isOpen} />;
};
