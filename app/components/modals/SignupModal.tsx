...
const SignupModal = () => {
    ...
    // Axios call
    // apiService.post(`/api/auth/register/`, JSON.stringify(formData)).then((res) => {
    ...
    return <Modal isOpen={signupModal.isOpen} close={signupModal.close} label="Sign up" content={content} />;
};
